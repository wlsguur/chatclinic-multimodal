...
# --- CXR tool suite (detection / segmentation / measurement / quality / screening) ---
class CxrToolResponse(BaseSourceResponse):
    """Shared response shape for all CXR tools (mirrors ImageSourceResponse)."""
    source_image_path: Optional[str] = None
    file_name: str = ""
    file_kind: str = "CXR"
    width: int = 0
...
class CxrDetectionResponse(CxrToolResponse):
    pass


class CxrSegmentationResponse(CxrToolResponse):
    pass


class CxrMeasurementResponse(CxrToolResponse):
    pass


class CxrQualityResponse(CxrToolResponse):
    pass


class CxrScreeningResponse(CxrToolResponse):
    pass


class CxrDetectionRequest(BaseModel):
    image_path: str
    score: Optional[float] = None
    file_name: Optional[str] = None


class CxrSegmentationRequest(BaseModel):
    image_path: str
    targets: Optional[str] = None
    file_name: Optional[str] = None


class CxrMeasurementRequest(BaseModel):
    image_path: str
    score: Optional[float] = None
    file_name: Optional[str] = None


class CxrQualityRequest(BaseModel):
    image_path: str
    file_name: Optional[str] = None


class CxrScreeningRequest(BaseModel):
    image_path: str
    score: Optional[float] = None
